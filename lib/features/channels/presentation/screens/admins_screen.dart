...
class ChannelAdminsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'Channel Administrators'),
          ...
          Container(
            ...
            child: const Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Channel administrators can manage subscribers, posts, stories, statistics, and channel settings.',
                  ),
                ),
              ],
            ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Channel administrators will appear here.',
